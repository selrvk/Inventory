...
public class Product {
    ...
    public Product(int id, String name, int stock, int srp, int buyingPrice, String manufacturer){
    ...
    public Product(String name, int stock, int srp, int buyingPrice, String manufacturer){
