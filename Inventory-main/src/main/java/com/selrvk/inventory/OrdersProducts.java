...
public class OrdersProducts {
    ...
    public OrdersProducts(int order_id, String product_name, int product_id, int order_quantity, double product_price){
    ...
    public OrdersProducts(String product_name, int product_id, int order_quantity, double product_price){
        this.product_name = product_name;
        this.product_id = product_id;
        this.order_quantity = order_quantity;
        this.product_price = product_price;
    ...
    public OrdersProducts(String product_name, int order_quantity, double product_price){
        this.product_name = product_name;
        this.order_quantity = order_quantity;
        this.product_price = product_price;
    }
